...
public class Posts {
   ...
   * @throws SQLException
   */
  public void add(Msg msg) throws SQLException, IOException {
   ...
   * @throws SQLException
   */
  public void delete(String messageid, String username) throws SQLException {
   ...
   * @throws SQLException
   */
  public void update(String messageid, Msg msg) throws SQLException {
   ...
   * @throws SQLException
   */
  public List<List<String>> search(String numberOfResults) throws SQLException {
