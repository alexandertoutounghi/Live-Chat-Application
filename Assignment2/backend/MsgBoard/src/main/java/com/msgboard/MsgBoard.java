...
public class MsgBoard {
  ...
  // Add. Add hashtags
  public void postHashtags(Msg msg, String messageid) throws SQLException, ClassNotFoundException {
    // Connect to database
   ...
   * @throws SQLException
   */
  public void postMsg(Msg msg) throws SQLException, IOException, ClassNotFoundException {
    // Connect to database
    DbAccess access = new DbAccess();
   ...
   * @throws SQLException
   */
  public void deleteMsg(String messageid, String username) throws SQLException, ClassNotFoundException {
    DbAccess access = new DbAccess();
   ...
   * @throws SQLException
   */
  public void updateMsg(String messageid, Msg msg) throws SQLException, ClassNotFoundException {
    DbAccess access = new DbAccess();
   ...
   * @throws SQLException
   */
  public List<List<String>> getMsg() throws SQLException, ClassNotFoundException {
    DbAccess access = new DbAccess();
   ...
   * @throws SQLException
   */
  public List<List<String>> getMsg(String numberOfResults) throws SQLException, ClassNotFoundException {
    DbAccess access = new DbAccess();
